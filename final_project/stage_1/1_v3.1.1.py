# Method 3: Recent Performance Comparison
...
# Update the target variable for test data using Recent Performance Comparison
# Determine predicted winner based on recent performance
test_data['home_team_win'] = (
    test_data['home_batting_onbase_plus_slugging_10RA'] >=
    test_data['away_batting_onbase_plus_slugging_10RA']
).astype(int)
