# Method 5: Combined Offensive and Defensive Metrics
...
# Update the target variable for test data using Combined Offensive and Defensive Metrics
# Calculate Offensive Strength
test_data['home_offense'] = (
    test_data['home_batting_onbase_plus_slugging_mean'] +
    test_data['home_batting_RBI_mean']
)
test_data['away_offense'] = (
    test_data['away_batting_onbase_plus_slugging_mean'] +
    test_data['away_batting_RBI_mean']
)

# Calculate Defensive Strength
test_data['home_defense'] = (
    -test_data['home_pitching_earned_run_avg_mean'] +
    test_data['home_pitching_SO_batters_faced_mean']
)
test_data['away_defense'] = (
    -test_data['away_pitching_earned_run_avg_mean'] +
    test_data['away_pitching_SO_batters_faced_mean']
)

# Compute Overall Strength
test_data['home_strength'] = test_data['home_offense'] + test_data['home_defense']
test_data['away_strength'] = test_data['away_offense'] + test_data['away_defense']

# Assign Proxy Target
test_data['home_team_win'] = (test_data['home_strength'] >= test_data['away_strength']).astype(int)
