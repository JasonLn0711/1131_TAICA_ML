...
# Update the target variable for test data using K-Means Clustering
...
kmeans = KMeans(n_clusters=2, random_state=42, n_init='auto') # Fix v1.1.2: adding "n_init='auto' " will adjust automatically based on the future versions, eliminating the warning.
kmeans.fit(X_scaled)
