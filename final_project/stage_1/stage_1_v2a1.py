...
# Update the target variable for test data using Weighted Scoring System
# Calculate home team score
test_data['home_score'] = (
    (test_data['home_batting_batting_avg_mean'] * 0.4) -
    (test_data['home_pitching_earned_run_avg_mean'] * 0.3) -
    (test_data['home_team_errors_mean'] * 0.2) +
    (test_data['home_team_rest'] * 0.1)
)

# Calculate away team score
test_data['away_score'] = (
    (test_data['away_batting_batting_avg_mean'] * 0.4) -
    (test_data['away_pitching_earned_run_avg_mean'] * 0.3) -
    (test_data['away_team_errors_mean'] * 0.2) +
    (test_data['away_team_rest'] * 0.1)
)

# Determine predicted winner
test_data['home_team_win'] = (test_data['home_score'] >= test_data['away_score']).astype(int)
